...
# 결과를 저장할 디렉토리 경로 설정
results_dir = "/content/drive/MyDrive/Deep-Learning-as-Statistical-Perspective/Images/gradcam_original_test_small/results"
# 디렉토리가 존재하지 않으면 생성
...
bs = 1
num_bs = 1
gradcam_test_small = GradCAMTest(gradcam=gradcam, idx_dict=idx_dict, img_list=img_list_O, bs=bs, num_bs=num_bs)
result_list = gradcam_test_small.gradcam_heatmap_calc()
gradcam_test_small.gradcam_heatmap_visualize(result_list=result_list, save_plot_dir=results_dir)
...
bs = 1
num_bs = 1
gradcam_test_small = GradCAMTest(gradcam=gradcam, idx_dict=idx_dict, img_list=img_list_T, bs=bs, num_bs=num_bs)
result_list = gradcam_test_small.gradcam_heatmap_calc()
gradcam_test_small.gradcam_heatmap_visualize(result_list=result_list, save_plot_dir=results_dir)
